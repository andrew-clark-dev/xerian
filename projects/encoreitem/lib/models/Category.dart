...
class Category extends amplify_core.Model {
  ...
  const Category._internal({required name, alt, metadata, active, updatedAt, createdAt}): _name = name, _alt = alt, _metadata = metadata, _active = active, _updatedAt = updatedAt, _createdAt = createdAt;
  
  factory Category({required String name, List<String>? alt, String? metadata, bool? active, amplify_core.TemporalDateTime? updatedAt}) {
  ...
  Category copyWith({List<String>? alt, String? metadata, bool? active, amplify_core.TemporalDateTime? updatedAt}) {
    return Category._internal(
      name: name,
      alt: alt ?? this.alt,
...
class CategoryModelIdentifier implements amplify_core.ModelIdentifier<Category> {
  ...
  /** Create an instance of CategoryModelIdentifier using [name] the primary key. */
  ...
  @override
  String toString() => 'CategoryModelIdentifier(name: $name)';
