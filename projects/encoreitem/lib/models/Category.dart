...
class Category extends amplify_core.Model {
  ...
  const Category._internal({required name, alt, metadata, active, createdAt, updatedAt}): _name = name, _alt = alt, _metadata = metadata, _active = active, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Category({required String name, List<String>? alt, String? metadata, bool? active}) {
  ...
  Category copyWith({List<String>? alt, String? metadata, bool? active}) {
    return Category._internal(
      name: name,
      alt: alt ?? this.alt,
