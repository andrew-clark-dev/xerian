...
class Group extends amplify_core.Model {
  ...
  const Group._internal({required name, alt, metadata, active, createdAt, updatedAt}): _name = name, _alt = alt, _metadata = metadata, _active = active, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Group({required String name, List<String>? alt, String? metadata, bool? active}) {
  ...
  Group copyWith({List<String>? alt, String? metadata, bool? active}) {
    return Group._internal(
      name: name,
      alt: alt ?? this.alt,
...
class GroupModelIdentifier implements amplify_core.ModelIdentifier<Group> {
  ...
  /** Create an instance of GroupModelIdentifier using [name] the primary key. */
  ...
  @override
  String toString() => 'GroupModelIdentifier(name: $name)';
